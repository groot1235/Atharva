        ...
        <div className='h-auto'>
            ...
            <div className='grid grid-cols-1 md:grid-cols-2 gap-4 mt-4'>
                <Card className='w-full p-3'>
                    <CardHeader>
                        <CardTitle><h1 className='text-2xl md:text-3xl flex flex-wrap items-center gap-2'><FolderCode className='text-amber-600 shrink-0' /> Coding</h1></CardTitle>
                    </CardHeader>
                    <CardContent>
                ...
                <Card className='w-full p-3'>
                    <CardHeader>
                        <CardTitle><h1 className='text-2xl md:text-3xl flex flex-wrap items-center gap-2'><ChessKnight className='text-amber-600 shrink-0' /> Chess</h1></CardTitle>
                    </CardHeader>
                    <CardContent>
                ...
                <Card className='w-full p-3'>
                    <CardHeader>
                        <CardTitle><h1 className='text-2xl md:text-3xl flex flex-wrap items-center gap-2'><Cpu className='text-amber-600 shrink-0' /> Learning New Technologies</h1></CardTitle>
                    </CardHeader>
                    <CardContent>
                ...
                <Card className='w-full p-3'>
                    <CardHeader>
                        <CardTitle><h1 className='text-xl md:text-3xl flex flex-wrap items-center gap-2'><Book className='text-amber-600 shrink-0' /> Reading</h1></CardTitle>
                    </CardHeader>
                    <CardContent>
